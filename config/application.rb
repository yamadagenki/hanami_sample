...
module HanamiSample
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['HANAMI_SAMPLE_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load HanamiSample::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time HanamiSample::Action is included
      ...
      # Configure the code that will yield each time HanamiSample::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include HanamiSample::Assets::Helpers
      end
    end
